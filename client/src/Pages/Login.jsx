...
import Facebook from '../utiles/Facebook.svg'
import github from '../utiles/github.svg'
      ...
      <div className='flex mt-8'>
        <div className='w-[350px] h-[255px] border-r ml-2 mt-4'>
          ...
          <div className=' mt-3 ml-2 flex '> 
            <button className='bg-black w-[300px]  h-[45px] rounded flex items-center hover:bg-white' onClick={loginWithGitHub}>
              <img src={github} alt="github"  className='h-6 ml-3 '/>
